(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('webpack'), require('fs'), require('source-map'), require('@vue/cli-service/webpack.config'), require('@babel/parser'), require('@babel/traverse'), require('@babel/types')) :
  typeof define === 'function' && define.amd ? define(['webpack', 'fs', 'source-map', '@vue/cli-service/webpack.config', '@babel/parser', '@babel/traverse', '@babel/types'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.codeScanner = factory(global.webpack, global.fs, global.sourceMap, global.baseWebpackConfig, global.babelParser, global.babelTraverse, global.babelTypes));
}(this, (function (webpack, fs, require$$0, baseWebpackConfig, parser, traverse, types$1) { 'use strict';
